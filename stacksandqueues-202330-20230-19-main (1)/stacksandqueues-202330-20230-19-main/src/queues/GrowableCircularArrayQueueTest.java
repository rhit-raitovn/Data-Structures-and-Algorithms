...
public class GrowableCircularArrayQueueTest {
	...
	public void testIsEmpty() {
		assertTrue("Expected: true", this.intQueue.isEmpty());
		assertTrue("Expected: true", this.stringQueue.isEmpty());
		this.stringQueue.enqueue("an item");
		assertFalse("Expected: false", this.stringQueue.isEmpty());
		points += 1;
	}
	 ...
	 */
	@Test
	public void testSizeWrapAround() {
		// Make sure it can handle the size if it wraps around
		this.intQueue.enqueue(17);
		this.intQueue.enqueue(18);
		this.intQueue.enqueue(19);
		this.intQueue.enqueue(20);
		this.intQueue.enqueue(21);
		this.intQueue.dequeue(); 
		this.intQueue.dequeue(); 
		this.intQueue.dequeue(); 
		this.intQueue.dequeue(); 
		this.intQueue.enqueue(22);
		this.intQueue.enqueue(23);
	...
	public void testContains() {
		addItemsToEachQueue();
		assertTrue("Expected: true", this.intQueue.contains(15));
		assertTrue("Expected: true", this.intQueue.contains(8));
		assertTrue("Expected: true", this.intQueue.contains(23));
		assertFalse("Expected: false", this.intQueue.contains(0));
		assertFalse("Expected: false", this.intQueue.contains(1));
		assertFalse("Expected: false", this.intQueue.contains(-1));
		
		assertTrue("Expected: true", this.stringQueue.contains("nice"));
		assertTrue("Expected: true", this.stringQueue.contains("job"));
		assertTrue("Expected: true", this.stringQueue.contains("work"));
		assertFalse("Expected: false", this.stringQueue.contains("help"));
		assertFalse("Expected: false", this.stringQueue.contains("not"));
		assertFalse("Expected: false", this.stringQueue.contains("here"));
		points += 3;
	}
