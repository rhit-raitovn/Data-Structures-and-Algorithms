...
public class GraphSurfingMilestone2Test {
	...
	private void helperTestShortestPathExampleGraphs(Graph<String> g, Graph<Integer> g2) {
		...
		assertTrue("Expected: true", Arrays.asList("a","b","d").equals(g.shortestPath("a","d")) 
	...
	public void testWikiSurfingShortestPath() {
		assertTrue("Expected: true", runLivingPeopleGraphTests);
		...
		assertTrue("Expected: true", isValidPath(path1)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", isValidPath(path2)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", isValidPath(path3)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", isValidPath(path4)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", isValidPath(path5)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", isValidPath(path9)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", isValidPath(path16)); // Check to make sure all are valid edges
		...
		assertTrue("Expected: true", path0 == null); // Check to make sure there was no solution
